...
export default function PackageComponent({ packageCard, borderColor }: Props) {
  return (
    <div
      className={twMerge(
        " border-4 border-yellow p-6 xl:pb-64 2xl:pb-64 w-full",
    ...
    >
      ...
      <LinkButton className="font-secondary text-lg w-full p-2 md:p-3 lg:p-3 xl:p-3 2xl:p-3 rounded-lg font-medium " href="#calendly">
    Explore Plan
      </LinkButton>
    </div>
  );
