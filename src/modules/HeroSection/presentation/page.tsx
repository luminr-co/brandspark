    ...
    <div className="relative">
      ...
      <section className="flex flex-col items-center pt-20 pb-36 lg:pb-60 xl:pb-60 2xl:pb-60">
        <video
          ...
          muted
        />
        <h1 className="font-primary text-2xl md:text-3xl lg:text-5xl xl:text-6xl 2xl:text-6xl text-center w-10/12 sm:flex md:flex lg:flex xl:flex 2xl:flex flex-row justify-center items-center ">
          Lightning Fast
        ...
        <p className="text-yellow font-primary text-2xl md:text-3xl lg:text-5xl xl:text-6xl 2xl:text-6xl text-center xl:mt-2">
          Thunderous Impact
        </p>
